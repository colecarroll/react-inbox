...
class Message extends React.Component {
  ...
  render() {
    ...
    classNames += this.props.message.read === true ? " read" : " unread";
    ...
    isStarred += this.props.message.starred === true ? "fa-star" : "fa-star-o";
      ...
      <div className={classNames}>
        <div className="col-xs-1">
          <div className="row">
            ...
            <div className="col-xs-2">
              <i className={isStarred} onClick={this.props.onStar} />
            </div>
          </div>
        </div>
